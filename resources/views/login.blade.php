...
<section class="bg-gray-50 dark:bg-gray-900">
  <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
          <img class="w-8 h-8 mr-2" src="https://d2gg9evh47fn9z.cloudfront.net/800px_COLOURBOX14899629.jpg" alt="logo">
          GEPODS MARIJUANA   
      </a>
              ...
              <form class="space-y-4 md:space-y-6" action="/logar" method="POST">
                @csrf
                  ...
                  <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                      Não tem cadastro? <a href="#" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Sign up</a>
                  </p>
              </form>
          </div>
      </div>
